...
export default class EditMakeDown extends Vue {
  ...
  // markdown的this
  public that_markdown: Vue | null = null;

  @Prop()
  public markdownValue: any;
  public that_insertContent: Function = () => {};
  ...
  public onReady({ vm, insertContent }: { vm: Vue; insertContent: Function }) {
    this.that_markdown = vm;
    this.that_insertContent = insertContent;
  }
  public handleOnSave({ value, theme }: { value: string; theme?: string }) {
